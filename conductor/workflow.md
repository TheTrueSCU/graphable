...
3.  **Execute Automated Tests with Proactive Debugging:**
    ...
    -   **Example Announcement:** "I will now run the automated test suite to verify the phase. **Command:** `just check`"
...
4.  **Propose a Detailed, Actionable Manual Verification Plan:**
    ...
    -   The plan you present to the user **must** follow this format:
        ...
        **For a CLI/Library Change:**
        ```
        The automated tests have passed. For manual verification, please follow these steps:

        **Manual Verification Steps:**
        1.  **Execute the following command in your terminal:** `graphable info examples/basic_usage.json`
        2.  **Confirm that you receive:** A summary table with nodes and edges.
        ```
...
- [ ] No linting or static analysis errors (using `just lint`)
...
4. **Security**
   ...
   - Secure parsing of external files (JSON, YAML, etc.)
...
- `conductor`: Conductor-specific tasks (plan updates, checkpoints)
...
### Deployment Steps (Publishing to PyPI)
1. Run `just publish` (which builds and uploads)
2. Verify release on PyPI
3. Check documentation site
