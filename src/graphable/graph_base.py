...
from .errors import GraphConsistencyError
from .graphable import Graphable

logger = getLogger(__name__)


class GraphBase[T: Graphable[Any]]:
    """
    Base class representing a graph of Graphable nodes.
    Supports both directed acyclic and cyclic structures.
    """

    def __init__(self, initial: set[T] | list[T] | None = None, discover: bool = False):
        """
        Initialize a GraphBase.
    ...
    def clone(self, include_edges: bool = False) -> GraphBase[T]:
        """
        ...
        Returns:
            GraphBase[T]: A new instance of the same class.
        """
        ...
        new_graph = self.__class__(set(node_map.values()))
    ...
    def __iter__(self):
        """
        Iterate over nodes in a deterministic order (by reference).
        """
        return iter(sorted(self._nodes, key=lambda n: str(n.reference)))
    ...
    @classmethod
    def read(cls, path: Path | str, **kwargs: Any) -> GraphBase[Any]:
    ...
    def subgraph_between(self, source: T, target: T) -> GraphBase[T]:
        """
        ...
        return self.__class__(between)

    def diff_graph(self, other: GraphBase[T]) -> GraphBase[T]:
        """
        ...
        Returns:
            GraphBase[T]: A merged graph with diff metadata.
        """
        ...
        new_graph = self.__class__(set(merged_nodes_map.values()))
    ...
    @staticmethod
    def parse(
        parser_fnc: Callable[..., GraphBase[Any]], source: str | Path, **kwargs: Any
    ) -> GraphBase[Any]:
        """
        ...
        Returns:
            GraphBase: A new instance populated from the source.
        """
        return parser_fnc(source, **kwargs)

    @classmethod
    def from_csv(cls, source: str | Path, **kwargs: Any) -> GraphBase[Any]:
    ...
    @classmethod
    def from_graphml(cls, source: str | Path, **kwargs: Any) -> GraphBase[Any]:
    ...
    @classmethod
    def from_json(cls, source: str | Path, **kwargs: Any) -> GraphBase[Any]:
    ...
    @classmethod
    def from_toml(cls, source: str | Path, **kwargs: Any) -> GraphBase[Any]:
    ...
    @classmethod
    def from_yaml(cls, source: str | Path, **kwargs: Any) -> GraphBase[Any]:
    ...
    def subgraph_filtered(self, fn: Callable[[T], bool]) -> GraphBase[T]:
        """
        ...
        Returns:
            GraphBase[T]: A new graph containing the filtered nodes.
        """
        logger.debug("Creating filtered subgraph.")
        return self.__class__([node for node in self._nodes if fn(node)], discover=True)

    def subgraph_tagged(self, tag: str) -> GraphBase[T]:
        """
        ...
        Returns:
            GraphBase[T]: A new graph containing the tagged nodes.
        """
    ...
    def upstream_of(self, node: T) -> GraphBase[T]:
        """
        ...
        Returns:
            GraphBase[T]: A new graph instance.
        """
    ...
    def downstream_of(self, node: T) -> GraphBase[T]:
        """
    ...
    def diff(self, other: GraphBase[T]) -> dict[str, Any]:
        """
    ...
    def render(
        ...
        **kwargs: Any,
        ...
        if transitive_reduction:
            if hasattr(self, "transitive_reduction"):
                target = getattr(self, "transitive_reduction")()
            else:
                logger.warning(
                    "Transitive reduction is only supported for AcyclicGraph. Rendering original graph."
                )
                target = self
        else:
            target = self
    ...
    def export(
        ...
        **kwargs: Any,
        ...
        Args:
            export_fnc: The export function to use.
        ...
        if transitive_reduction:
            if hasattr(self, "transitive_reduction"):
                ...
                logger.warning(
                    "Transitive reduction is only supported for AcyclicGraph. Exporting original graph."
                )
                target = self
        else:
            target = self
